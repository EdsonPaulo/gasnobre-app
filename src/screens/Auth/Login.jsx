...
const Login = () => {
  ...
  return (
    <SafeAreaView style={styles.background}>
      ...
      >
        <View
          style={[{ paddingHorizontal: metrics.baseMargin, width: '100%' }]}
        >
          <Text style={styles.subtitle}>
            Informe as suas credenciais (email e senha) para iniciar sessão na
            sua conta
          </Text>
      ...
      <View style={{ marginVertical: metrics.doubleBaseMargin }}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('forgot')}>
          <Text style={[styles.bottomText, { marginTop: metrics.baseMargin }]}>
